...
def draw_chart(tasks, canvas,
    ...
    for task_number in start_days:
        task = tasks[task_number]
        canvas.create_text(title_indent,
                           y + row_height / 2,
                           text=task.title,
                           anchor=tkinter.W,
...
canvas = tkinter.Canvas(root, width=800, height=400, bg="gray")
